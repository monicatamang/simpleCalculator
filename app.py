...
def check_invalid_chars(user_input):
    ...
    # Using the regular expression library in python, the compile and search methods are used to store and find all characters, from the raw string, that are not digits, i.e., any number between 0 and 9
...
try:
    ...
    for user_input_char in user_input_strings:
        ...
        # If invalid characters are found, raise the CalculatorInputError exception and create an object instance with the following error message
